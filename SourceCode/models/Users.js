...
module.exports.getMembers = (adminId) => {
    return new Promise((resolve, reject) => {
        Members.findAll({
            ...
            var p;
            data.forEach(member => {
                p = Users.findByPk(member.dataValues.userId).then(data => {
...
module.exports.updateUser = (id, userName, userAddress, userYear, userContact) => {
    return new Promise((resolve, reject) => {
...
module.exports.updatePassword = (id, oldPassword, newPassword) => {
    return new Promise((resolve, reject) => {
        Users.findByPk(id).then(user => {
            bcrypt.compare(oldPassword, user.get().userPassword, (e, isMatch) => {
                if(e){
                    return reject(e);
                }else if(isMatch){
