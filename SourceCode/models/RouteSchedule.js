            ...
            if(data.length == 0){
                ...
                data.forEach(el => {
                    ...
                    p = Schedule.findByPk(scheduleId).then(data => {
                        schedule = data.get();
                        schedule.text = "Departure : "+schedule.departure+", Arrival : "+schedule.arrival;
                        if(schedule.status){
                ...
                Promise.all(promiseArray).then(() => {
                        ...
                        var departureA = parseInt(a.departure.split(':')[0]);
                        var departureB = parseInt(b.departure.split(':')[0]);
